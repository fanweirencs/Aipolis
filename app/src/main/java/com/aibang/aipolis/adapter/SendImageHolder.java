...
import com.aibang.aipolis.activity.ImageActivity;
import com.aibang.aipolis.base.ImageLoaderFactory;
...
public class SendImageHolder extends BaseViewHolder {
  ...
  public void bindData(Object o) {
    ...
    User my = BmobUser.getCurrentUser(getContext(), User.class);
    ImageLoader.getInstance().displayImage(my.getAutographUrl(),iv_avatar);
//    ImageLoaderFactory.getLoader().loadAvator(iv_avatar,my != null ? my.getAutographUrl() : null,R.mipmap.default_head_male);
...
//        toast("点击图片:"+(TextUtils.isEmpty(message.getRemoteUrl()) ? message.getLocalPath():message.getRemoteUrl())+"");
        ...
        intent.putExtra("imagePath",(TextUtils.isEmpty(message.getRemoteUrl()) ? message.getLocalPath():message.getRemoteUrl()));
