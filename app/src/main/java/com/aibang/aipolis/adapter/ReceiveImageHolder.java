...
public class ReceiveImageHolder extends BaseViewHolder {
  ...
  public void bindData(Object o) {
    ...
    ImageLoader.getInstance().displayImage(info.getAvatar(),iv_avatar);
//    ImageLoaderFactory.getLoader().loadAvator(iv_avatar,info != null ? info.getAvatar() : null, R.mipmap.default_head_male);
...
//        toast("点击图片:"+message.getRemoteUrl()+"");
        ...
        intent.putExtra("imagePath",message.getRemoteUrl());
